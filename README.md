...
Thank you for considering contributing to Stripe Pad! You can read the contribution guide [here](.github/CONTRIBUTING.md).
...
Feel free to log an issue on our [GitHub issues page](https://github.com/natzar/Stripe-Pad/issues) or  [@betoayesa](https://www.twitter.com/betoayesa) is always open as well.
