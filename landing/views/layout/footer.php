  ...
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      <div class="space-y-8">
        ...
        <iframe src="https://github.com/sponsors/natzar/button" title="Sponsor natzar" height="32" width="114" style="border: 0; border-radius: 6px;display:inline"></iframe>
        <a href="https://www.github.com/natzar/Stripe-Pad" target="_blank" class="items-center inline text-base font-semibold leading-6 text-gray-400 px-3 py-1 hover:bg-gray-900 hover:text-sky-500 rounded-full"> <svg class="h-6 w-6 inline " fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <div class="mt-10 border-t border-white/10 pt-8 ">
      <p class="text-xs leading-5 text-gray-400">&copy; <a href="<?= LANDING_URL ?>"><?= LANDING_URL ?></a> <?= $SEO_TITLE ?> &copy; <?= Date("Y") ?> All rights reserved</p>
      <p class="text-xs leading-5 text-gray-500">
        Powered by <a href="//stripepad.com">Stripe Pad v.<?= STRIPE_PAD_VERSION ?></a> · Get Support: <a href="mailto:<?= ADMIN_EMAIL ?>"><?= ADMIN_EMAIL ?></a></p>
