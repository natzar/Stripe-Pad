...
<div class="sticky w-full  z-50 bg-white items-center  shadow-xl  ">
  <div class="text-gray-100 flex gap-x-2 bg-blue-900 px-6 py-0.5 sm:px-3.5 text-center items-center ">
    <a class="text-sm z-50 hover:underline mx-auto hover:font-semibold" href="<?= LANDING_URL ?>demo"> <strong class="text-sm leading-6 text-gray-100 font-semibold inline"><?= _('TOP CTA - app/views/layout/public/menu-public.php') ?></strong>
  ...
  <header class="mx-auto w-full z-40    ">
    <nav class="flex items-center md:justify-between w-full d:justify-start p-6 lg:px-8 " aria-label="Global">
      <div class="flex lg:flex-1">
        ...
        <a href="<?= LANDING_URL ?>" class=" -m-1.5 p-1.5 text-gray-900 hover:text-blue-900 font-bold">
      ...
      <div class="hidden lg:flex sm:gap-x-1 lg:gap-x-3 items-center">
        ...
        <a href="<?= LANDING_URL ?>" class="text-md font-semibold leading-6 text-gray-600 px-3 py-1 hover:bg-gray-50 hover:text-blue-900 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline">
        ...
        <!-- <a href="<?= LANDING_URL ?>screencasts" class="text-base font-semibold leading-6 text-gray-400 px-3 py-1 hover:bg-gray-900 hover:text-blue-900 rounded-full">Screencasts</a> -->
        ...
        <a href="<?= LANDING_URL ?>faq" class="text-md font-semibold leading-6 text-gray-600 px-3 py-1 hover:bg-gray-50 hover:text-blue-900 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline">
            <path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" />
          </svg>

          <?= _('FAQ') ?></a>

        <a href="<?= LANDING_URL ?>pricing" class="text-base font-semibold leading-6 text-gray-600 px-3 py-1 hover:bg-gray-50 hover:text-blue-900 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline">
