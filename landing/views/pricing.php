<!-- PRICING -->
<div id="pricing" class="bg-slate-900 py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-4xl text-center">
            <p class="mt-2 text-balance text-5xl font-semibold tracking-tight text-white sm:text-6xl"><?= _('Pricing') ?></p>
        </div>
        ...
        <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <!-- Plan 1 -->
            <div class="rounded-3xl bg-slate-800/90 p-8 ring-1 ring-white/10 xl:p-10">
                <div class="flex items-center justify-between gap-x-4">
                    <h3 id="tier-basic" class="text-lg/8 font-semibold text-white"><?= _('Basic') ?></h3>
                </div>
                <p class="mt-4 text-sm/6 text-gray-300"><?= _('Lorem ipsum dolor sit amet, consectetur adipiscing elit.') ?></p>
            ...
            <!-- Plan 2 -->
            <div class="rounded-3xl bg-slate-800 p-8 ring-2 ring-blue-500/80 shadow-xl xl:p-10">
                <div class="flex items-center justify-between gap-x-4">
                    <h3 id="tier-pro" class="text-lg/8 font-semibold text-white"><?= _('Pro') ?></h3>
                    <p class="rounded-full bg-blue-500/90 px-2.5 py-1 text-xs/5 font-semibold text-white"><?= _('Most popular') ?></p>
                </div>
                <p class="mt-4 text-sm/6 text-gray-300"><?= _('Ut enim ad minim veniam, quis nostrud exercitation ullamco.') ?></p>
                <p class="mt-6 flex items-baseline gap-x-1">
                ...
                <a href="#" aria-describedby="tier-pro" class="mt-6 block rounded-md bg-blue-500 px-3 py-2 text-center text-sm/6 font-semibold text-white shadow-sm hover:bg-blue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400"><?= _('Get started') ?></a>
                <ul role="list" class="mt-8 space-y-3 text-sm/6 text-gray-300 xl:mt-10">
                    <li class="flex gap-x-3">✔ <?= _('Lorem ipsum dolor sit amet') ?></li>
            ...
            <div class="rounded-3xl bg-slate-800/90 p-8 ring-1 ring-white/10 xl:p-10">
                <div class="flex items-center justify-between gap-x-4">
                    <h3 id="tier-enterprise" class="text-lg/8 font-semibold text-white"><?= _('Enterprise') ?></h3>
                </div>
                <p class="mt-4 text-sm/6 text-gray-300"><?= _('Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque.') ?></p>
