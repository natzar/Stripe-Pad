 ...
 * @var string
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'git@bitbucket.org:gophpninja/chatleads.git');
 ...
 */
if (!defined('TARGET_DIR')) define('TARGET_DIR', dirname(__FILE__).'/../');
 ...
 */
if (!defined('COMPOSER_HOME')) define('COMPOSER_HOME','/usr/home/domstl/tmp/composer');
 ...
 */
if (!defined('EMAIL_ON_ERROR')) define('EMAIL_ON_ERROR', 'beto.phpninja@gmail.com');
...
if (defined('USE_COMPOSER') && USE_COMPOSER === true) {
	$commands[] = sprintf(
		'/usr/bin/composer --no-ansi --no-interaction --no-progress --working-dir=%s install %s'
		, TMP_DIR
