...
<script>
  ...
  gtag('config', 'G-7PND9VPM5D');
		...
		<meta name="title" content="Counterify | Tally Counter API">
	    <meta name="keywords" content="digital counter, counter api, tally counter api, tally api, counter api, digital tally counter api">
	    <meta name="author" content="Php Ninja">
		<meta name="description" content="A digital tally counter tool tht allows you to count everything effortlessly via API and mobile Web App">
    ...
    <link rel="canonical" href="https://www.counterify.com">
...
<!-- Open Graph Meta Tags -->
    ...
    <style>
	code{ font-family:'Courier New',Courier, serif;overflow-x:scroll;}
	</style>
...
-->
      <div class="text-center">
        ...
        <!-- <h2>Digital Tally Counter & API</h2> -->
        <p class="mt-6 max-w-3xl mx-auto text-md leading-6 text-gray-600">A simple but powerful digital tally counter to measure and quantify everything to make better data-driven decisions</p>



        <div class="mt-10 flex items-center justify-center gap-x-6">
         
          <a href="https://app.counterify.com/signup" type="button" class="rounded-full shadow-md inline-flex bg-indigo-600 py-4 px-6 text-lg font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Signup, try it for free <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="-mr-0.5 ml-2 h-7 w-7">
  <path stroke-linecap="round" stroke-linejoin="round" d="M12.75 15l3-3m0 0l-3-3m3 3h-7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
         ...
         <p class="text-xs text-gray-600 mt-4 block">Open BETA, free signup</p>
    ...
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div class="lg:pr-8 lg:pt-4">
        <div class="lg:max-w-lg">
          ...
          <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">How much? How many?</p>
  ...
  <div class="flow-root bg-white pb-24 sm:pb-32">
    <div class="-mt-80">
      ...
      <div>
        ...
        <p class="mt-6 text-base leading-7 text-gray-600">Start with our free tier! We are in BETA so it's free & unlimited</p>
