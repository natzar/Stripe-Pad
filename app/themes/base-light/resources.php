...
<div class=" px-6 py-24 pb-8 sm:pt-16 sm:pb-16 lg:px-8 border-gray-800 border-b">
  <div class="mx-auto max-w-2xl text-center">
    <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl nunito">{Resources}</h1>
    <!-- <p class="mt-6 text-lg leading-8 text-gray-300">If you are working with domains you may find these links interesting</p> -->
  </div>
</div>


<div class="max-w-7xl mx-auto text-gray-400  px-4 mt-10">
      ...
      <article class="flex flex-col items-start justify-between">
        ...
        <div class="max-w-xl">
          ...
          <div class="group relative">
            <h3 class="mt-3 text-lg font-semibold leading-6 text-green-500 group-hover:text-gray-600 nunito">
              <a href="resources/<?= $item['slug'] ?>" class="">
          ...
          <div class="mt-8 flex items-center gap-x-4 text-xs">
            ...
            <a href="#" class="relative z-10 rounded-full bg-green-700 px-3 py-1 font-medium text-gray-100 hover:bg-gray-100">Marketing</a>
          </div>
