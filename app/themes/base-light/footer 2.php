...
<div class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl border-b border-gray-800  sm:px-16 ">
      <h2 class="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-white sm:text-4xl">Boost your e-mail marketing today.</h2>
      <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">Experience unparalleled growth and engagement in your campaigns. Sign up and show 50 results instead of 20 for free</p>
      <div class="mt-10 flex items-center justify-center gap-x-6">
        <a href="/signup" class="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Sign up</a>
