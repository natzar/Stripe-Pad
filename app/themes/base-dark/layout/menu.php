...
<div class="bg-transparent  shadow-lg ">
  <header class="mx-auto max-w-7xl z-50 border-b relative border-gray-800 ">
 ...
 <span class="nunito"><?= APP_NAME ?></span>
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="https://www.github.com/natzar/Stripe-Pad" target="_blank" class="text-base font-semibold leading-6 text-gray-600 px-3 py-1 hover:bg-gray-900 hover:text-red-500 rounded-full">Download</a>
        
        <a href="<?= APP_BASE_URL ?>examples" class="text-base font-semibold leading-6 text-gray-600 px-3 py-1 hover:bg-gray-900 hover:text-red-500 rounded-full">Examples</a>
