...
<? endif; ?>
  ...
  <div class=" mt-1 sm:mt-5 mb-4 sm:px-6 w-full prose max-w-8xl prose-green text-gray-600 mx-auto  ">
  <!--
    ...
    <form class="space-y-6" action="actionLogin" method="POST">
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="forgotPassword" class="font-semibold text-green-600 hover:text-green-500">Forgot password?</a>
          </div>
        </div>
        <div class="mt-2">
          <input id="password" name="password" type="password"  required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6">
        </div>
      </div>
...
<?= $_SESSION['errors'] ?>
    <p class="mt-10 text-center text-sm text-gray-500">
      Not a member?
      <a href="signup" class="font-semibold leading-6 text-green-600 hover:text-green-500">Signup</a>
    </p>
  </div>
</div>
