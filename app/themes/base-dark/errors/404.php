...
<html class="h-full">
  <head>
    <meta charset="utf-8">
    <title>RefBoost | The Simple Referrals Widget | 404</title>
...
<div class="flex min-h-screen flex-col bg-white pt-16 pb-12">
  <main class="mx-auto flex w-full max-w-7xl flex-grow flex-col justify-center px-4 sm:px-6 lg:px-8">
    <div class="flex flex-shrink-0 justify-center">
      <a href="/" class="inline-flex">
        ...
        <img class="h-12 w-auto" src="https://refboost.com/refboost-logo.png" alt="">
      </a>
    </div>
    <div class="py-16">
      <div class="text-center">
        ...
        <div class="mt-6">
          <a href="https://refboost.com" class="text-base font-medium text-indigo-600 hover:text-indigo-500">
            Go back home
  ...
  <footer class="mx-auto w-full max-w-7xl flex-shrink-0 px-4 sm:px-6 lg:px-8">
    <nav class="flex justify-center space-x-4">
      <a href="mailto:hello@refboost.com" class="text-sm font-medium text-gray-500 hover:text-gray-600">Contact Support</a>
