...
<div class=" px-6 py-24 pb-8 sm:pt-32 sm:pb-16 lg:px-8 border-gray-800 border-b">
  <div class="mx-auto max-w-2xl text-center">
    <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl nunito">{Browse}</h1>
    <p class="mt-4 text-sm leading-8 text-gray-500">Browse full catalog</p>
  </div>
</div>
...
<div class="">
  <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="lg:text-center">
      <h3 class="text-sm font-bold leading-8 uppercase  tracking-tight text-gray-600  sm:leading-9">
        Popular
      </h3>
    </div>
     <div class="mt-10">
...
<div class="">
  <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="lg:text-center">
      <h3 class="text-sm font-bold leading-8 uppercase  tracking-tight text-gray-500   sm:leading-9">
        List of domains
      </h3>
    </div>
