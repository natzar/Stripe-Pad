...
<!-- Breadcrumb -->
<nav class="hidden bg-white border-t border-b border-gray-200 lg:flex mb-10" aria-label="Breadcrumb">
  <ol class="ml-4 w-full mx-auto px-4 flex space-x-4 sm:px-6 lg:px-8">
    <li class="flex">
    ...
    <ul role="list" class="mt-4 border-t border-b border-gray-200 divide-y divide-gray-200">
      <li class="py-4 flex items-center justify-between space-x-3">
        ...
        <div class="flex-shrink-0">
          <button type="button" class="inline-flex items-center py-2 px-3 border border-transparent rounded-full bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            ...
            <span class="text-sm font-medium text-gray-900"> Invite <span class="sr-only">Lindsay Walton</span> </span>
          </button>
        </div>
      </li>
      ...
      <li class="py-4 flex items-center justify-between space-x-3">
        <div class="min-w-0 flex-1 flex items-center space-x-3">
          ...
          <div class="min-w-0 flex-1">
            <p class="text-sm font-medium text-gray-900 truncate">Courtney Henry</p>
            <p class="text-sm font-medium text-gray-500 truncate">Designer</p>
          </div>
        </div>
        <div class="flex-shrink-0">
          <button type="button" class="inline-flex items-center py-2 px-3 border border-transparent rounded-full bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            ...
            <span class="text-sm font-medium text-gray-900"> Invite <span class="sr-only">Courtney Henry</span> </span>
          </button>
        </div>
      </li>
      ...
      <li class="py-4 flex items-center justify-between space-x-3">
        <div class="min-w-0 flex-1 flex items-center space-x-3">
          ...
          <div class="min-w-0 flex-1">
            <p class="text-sm font-medium text-gray-900 truncate">Tom Cook</p>
            <p class="text-sm font-medium text-gray-500 truncate">Director, Product Development</p>
          </div>
        </div>
        <div class="flex-shrink-0">
          <button type="button" class="inline-flex items-center py-2 px-3 border border-transparent rounded-full bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            ...
            <span class="text-sm font-medium text-gray-900"> Invite <span class="sr-only">Tom Cook</span> </span>
          </button>
        </div>
      </li>
    </ul>
