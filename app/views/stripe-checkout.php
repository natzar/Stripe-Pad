...
<div class="py-12 ">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
    <div class="lg:text-center items-center m-auto">
	    <img class="mx-auto mb-5" width="100" src="<?= APP_LOGO ?>">
      <h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase"><?= APP_NAME ?></h2>
...
$(document).ready(function(e){	  
		   ...
		   var data_stripe = {
		    	...
		    	customer: <?= !$user ?  '[]':json_encode($user)  ?>,
		    ...
		    $.post('<?= APP_DOMAIN ?>stripe_create_session',data_stripe, function(data,error){

		    	var stripe = Stripe('<?=APP_STRIPE_PUBKEY ?>'); 
