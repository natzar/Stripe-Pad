...
order-b border-gray-800 
      ...
      <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li>
                <a href="<?= APP_DOMAIN ?>expired-domains" class="text-sm leading-6 text-gray-300 hover:text-white">Leads for Email Marketing</a>
              </li>
              <li>
        ...
        <a href="<?= APP_DOMAIN ?>resources" class="text-sm leading-6 text-gray-300 hover:text-white">Resources</a></li>
              <li>
