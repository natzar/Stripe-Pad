<div class="mx-auto mb-5">
    ...
    <nav class="flex mb-4" aria-label="Breadcrumb">
        <ol role="list" class="flex items-center space-x-4">
            <li>
                <div>
                    <a href="<?= APP_DOMAIN ?>" class="text-gray-400 hover:text-gray-500">
    ...
    <div class="flex items-center space-x-4">
        <img src="https://david.gophpninja.com/cdn/emilio-agente-atencion-cliente-email-ai.png" alt="Foto" class="w-12 h-12 rounded-full" />
        <p class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-950 sm:text-4xl"><?= $SEO_TITLE ?></p>

    </div>
    <p class="text-gray-600 mt-2 text-md block max-w-2xl leading-6"><?= $SEO_DESCRIPTION ?></p>
