            ...
            <table class="table-auto w-full">
                ...
                <tbody>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <a class="bg-sky-500 hover:bg-sky-700 text-white py-2 px-3 font-bold rounded-full" href="<?= APP_DOMAIN ?>checkout/<?= $p['productsId'] ?>/<?= $_SESSION['user']['usersId'] ?>" class="text-blue-500 hover:text-blue-800">Order now &raquo;</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
