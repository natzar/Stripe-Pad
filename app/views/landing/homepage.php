...
<div class="px-6  py-10 sm:pt-8 lg:overflow-hidden lg:pb-14 lg:pt-8 ">
  <div class="mx-auto max-w-7xl lg:px-8">
    <div class="">
      <div class="  max-w-3xl mx-auto sm:text-center lg:flex lg:items-center lg:px-0 lg:text-center justify-center">
        <div class="text-center">
          ...
          <div class="mt-5 text-center mx-auto">
            ...
            <div class="min-w-0 flex-1 w-full text-center">
              <div class=" flex gap-x-4 w-full mx-auto text-center justify-center">
                <a href="<?= APP_DOMAIN ?>documentation" class="inline-block rounded-lg bg-red-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-red-600 hover:bg-red-700 hover:ring-red-700">
                  START HERE
          ...
          <div class="mt-8 justify-center mx-auto text-left ">
            ...
            <div class="flex space-x-3 mt-4 justify-center mx-auto text-center ">
              <p class="text-gray-600 text-xs">Enjoyable with:</p>

              <svg class="w-8 h-8 inline " viewBox="175.7 78 490.6 436.9" xmlns="http://www.w3.org/2000/svg">
                <g fill="#4b4b4b">
              ...
              <svg class="w-8 h-8 inline" viewBox="0 0 256 221" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                <path d="M204.8 0H256L128 220.8 0 0h97.92L128 51.2 157.44 0h47.36z" fill="#41B883" />
                <path d="M0 0l128 220.8L256 0h-51.2L128 132.48 50.56 0H0z" fill="#4b4b4b" />
                <path d="M50.56 0L128 133.12 204.8 0h-47.36L128 51.2 97.92 0H50.56z" fill="#35495E" />
              </svg>

              <svg class="w-8 h-8 inline" viewBox=".5 -.2 1023 1024.1" xmlns="http://www.w3.org/2000/svg">
                <g fill="#4b4b4b">
              ...
              <svg class="w-8 h-8 inline" viewBox="-.65894164 8.03694707 65.54579331 48.12892285" xmlns="http://www.w3.org/2000/svg">
                <g stroke-width=".5">
                  <path d="m19.455 54.151a2.378 2.378 0 0 1 -.127-.26 3.334 3.334 0 0 1 -.226-1.88h-15.13l22.485-39.57 7.382 12.977 2.14-3.787-6.435-11.336a3.933 3.933 0 0 0 -3.14-2.074 3.496 3.496 0 0 0 -3.048 2.1l-22.779 40.05a4.028 4.028 0 0 0 -.2 3.78 3.505 3.505 0 0 0 3.334 1.608h19.079a3.496 3.496 0 0 1 -3.334-1.608z" fill="#4b4b4b" />
                  <path d="m63.319 50.37-18.719-32.973a3.943 3.943 0 0 0 -3.154-2.1 3.486 3.486 0 0 0 -3.046 2.093l-2.421 4.24 2.154 3.788 3.333-5.901 18.519 32.493h-7.042a3.153 3.153 0 0 1 -.147 1.6 2.029 2.029 0 0 1 -.147.327l-.06.12a4.03 4.03 0 0 1 -3.394 1.7h11.016a4.024 4.024 0 0 0 3.394-1.7 3.497 3.497 0 0 0 -.286-3.687z" fill="#4b4b4b" />
