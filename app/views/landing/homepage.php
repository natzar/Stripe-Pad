...
<div class="text-center max-w-3xl mx-auto mb-5">
 <h2 class="text-base font-semibold leading-7 text-blue-400">Focus on what makes your app unique</h2>
  ...
  <div class="divide-y divide-gray-200 overflow-hidden rounded-xl bg-gray-900 shadow sm:grid sm:grid-cols-2 sm:gap-px sm:divide-y-0">
    ...
    <div class="group relative bg-gray-900 p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-gray-700">
      <div>
        <span class="inline-flex rounded-lg bg-gray-800 p-3 text-yellow-700 ring-4 ring-gray-700">
          <svg class="size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
    ...
    <div class="group relative rounded-bl-lg rounded-br-lg bg-gray-900 p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-500 sm:rounded-bl-none">
      ...
      <div class="mt-8">
        ...
        <p class="mt-2 text-sm text-gray-500">Guides and tutorials are being written, if you need help please get in touch support@stripepad.com</p>
      </div>
      <span class="pointer-events-none absolute right-6 top-6 text-gray-300 group-hover:text-gray-400" aria-hidden="true">
        <svg class="size-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M20 4h1a1 1 0 00-1-1v1zm-1 12a1 1 0 102 0h-2zM8 3a1 1 0 000 2V3zM3.293 19.293a1 1 0 101.414 1.414l-1.414-1.414zM19 4v12h2V4h-2zm1-1H8v2h12V3zm-.707.293l-16 16 1.414 1.414 16-16-1.414-1.414z" />
     ...
     <div class="group relative ">
      ...
      <div class="mt-4 flex justify-between">
        <div>
          ...
          <p class="mt-1 text-sm text-gray-500">User: demo / Password: demo</p>
        </div>
     ...
     <div class="group relative ">
      ...
      <div class="mt-4 flex justify-between">
        <div>
          ...
          <p class="mt-1 text-sm text-gray-500">User: superadmin / Password: superadmin</p>
        </div>
