...
-->
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <? if (isset($_SESSION['errors']) and !empty($_SESSION['errors'])): ?>
      <div class="sm:mx-auto rounded-md mt-5 sm:w-full sm:max-w-sm bg-gray-900 border-blue-600 border-1 border py-4 px-5 font-semibold text-blue-600">
        <?= $_SESSION['errors'] ?>
      </div>
    <? endif; ?>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        Not a member?
        <a href="signup" class="font-semibold leading-6 text-blue-600 hover:text-blue-500">Signup</a>
      </p>
    </div>
  </div>
