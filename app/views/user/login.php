...
<div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-md">
    ...
    <h2 class="mt-6 text-center text-2xl/9 font-bold tracking-tight text-gray-100">Sign in to your account</h2>
  </div>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
    <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
      <form class="space-y-6" action="<?= APP_DOMAIN ?>actionLogin" method="POST">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm/6">
            <a href="<?= APP_DOMAIN ?>forgotPassword" class="font-semibold text-sky-600 hover:text-sky-500">Forgot password?</a>
          </div>
        </div>
        <input type="text" name="hney" value="" style="display: none;" ;>
        <div>
          <button type="submit" class="flex w-full justify-center rounded-md bg-sky-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600">Sign in</button>
        </div>
      </form>
    ...
    <p class="mt-10 text-center text-sm/6 text-gray-500">
      Not a member?
      <a href="<?= APP_DOMAIN ?>signup" class="font-semibold text-sky-600 hover:text-sky-500">Sign up now</a>
    </p>
  </div>
</div>