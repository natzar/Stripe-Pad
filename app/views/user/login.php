...
<div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
    <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
      <form class="space-y-6" action="<?= APP_DOMAIN ?>actionLogin" method="POST">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm/6">
            <a href="<?= APP_DOMAIN ?>forgotPassword" class="font-semibold text-indigo-600 hover:text-indigo-500">Forgot password?</a>
          </div>
        </div>
    ...
    <p class="mt-10 text-center text-sm/6 text-gray-500">
      Not a member?
      <a href="<?= APP_DOMAIN ?>signup" class="font-semibold text-indigo-600 hover:text-indigo-500">Sign up now</a>
    </p>
  </div>
</div>