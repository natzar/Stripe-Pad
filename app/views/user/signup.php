...
<div class=" mt-1 sm:mt-5 mb-4 sm:px-6 w-full prose max-w-8xl prose-blue text-gray-600 mx-auto   ">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="<?= APP_DOMAIN ?>actionSignup" method="POST">
        <div>
          ...
          <div class="mt-2">
            <input id="email" name="email" type="email" placeholder="email@mail.com" autocomplete="email" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
          </div>
        </div>
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm"> -->
        <!-- <a href="forgotPassword" class="font-semibold text-blue-600 hover:text-blue-500">Forgot password?</a> -->
        <!--    </div>
        </div>
        <div class="mt-2">
