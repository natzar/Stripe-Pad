                            ...
                            <li>
                                <ul class="-mx-2 space-y-1">
                                    <li>
                                        ...
                                        <a href="<?= ADMIN_URL ?>" class="group flex gap-x-3 rounded-md bg-gray-50 p-2 text-sm text-blue-600">
        ...
        <div class="flex grow flex-col overflow-y-auto bg-gray-100 px-4 pb-4">
            ...
            <nav id="sidebar" class="p">
                <ul class="-mx-2 space-y-1">
                    <li>
                        <!-- Current: "bg-gray-50 text-blue-600", Default: "text-gray-700 hover:text-blue-600 hover:bg-gray-50" -->
                        <a href="<?= ADMIN_URL ?>" class="group flex gap-x-3 rounded-md p-2 text-sm text-gray-800 hover:bg-gray-50 hover:text-blue-600">
                    ...
                    <!-- <li class="mb-5">
                        <a href="<?= ADMIN_URL ?>app_config_inbox" class="group flex gap-x-3 rounded-md p-2 text-sm text-gray-800 hover:bg-gray-50 hover:text-blue-600">
                    ...
                    <li>
                        ...
                        <ul role="list" class=" space-y-1">
                            ...
                            <li>
                                <a href="<?= ADMIN_URL ?>table/users" class="group flex gap-x-3 rounded-md p-2 text-sm text-gray-800 hover:bg-gray-50 hover:text-blue-600">
                                    <svg class="size-6 shrink-0 text-gray-400 group-hover:text-blue-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                                    </svg>
                                    Users
                            ...
                            <li>
                                <a href="<?= ADMIN_URL ?>table/products" class="group flex gap-x-3 rounded-md p-2 text-sm text-gray-800 hover:bg-gray-50 hover:text-blue-600">
                                    <svg class="size-6 shrink-0 text-gray-400 group-hover:text-blue-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
                            ...
                            <li>
                                <a href="<?= ADMIN_URL ?>table/subscriptions" class="group flex gap-x-3 rounded-md p-2 text-sm text-gray-800 hover:bg-gray-50 hover:text-blue-600">
                                    <svg class="size-6 shrink-0 text-gray-400 group-hover:text-blue-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
                            ...
                            <li>
                                <a href="<?= ADMIN_URL ?>table/invoices" class="group flex gap-x-3 rounded-md p-2 text-sm text-gray-800 hover:bg-gray-50 hover:text-blue-600">
                                    <svg class="size-6 shrink-0 text-gray-400 group-hover:text-blue-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
                            ...
                            <li>
                                <a href="<?= ADMIN_URL ?>table/crons" class="group flex gap-x-3 rounded-md p-2 text-sm text-gray-800 hover:bg-gray-50 hover:text-blue-600">
                            ...
                            <li>
                                <a href="<?= ADMIN_URL ?>comingsoon" class="group flex gap-x-3 rounded-md p-2 text-sm text-gray-800 hover:bg-gray-50 hover:text-blue-600">
                            ...
                            <li>
                                <a href="<?= ADMIN_URL ?>table/subscribers" class="group flex gap-x-3 rounded-md p-2 text-sm text-gray-800 hover:bg-gray-50 hover:text-blue-600">
                ...
                <div class="flex items-center gap-x-4 lg:gap-x-6">
                    ...
                    <div class="relative">
                        ...
                        <div id="user-submenu" class="hidden  absolute right-0 z-10 mt-2.5 w-64 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                            ...
                            <a href="<?= ADMIN_URL ?>profile" class="block px-3 py-1 text-sm text-gray-900 hover:font-bold hover:text-black" role="menuitem" tabindex="-1" id="user-menu-item-0"><?= _('Preferencias') ?></a>
                            <a href="<?= ADMIN_URL ?>actionLogout" class="block px-3 py-1 text-sm text-gray-900 hover:font-bold hover:text-black" role="menuitem" tabindex="-1" id="user-menu-item-1">
                                <?= _('Cerrar Sesión') ?></a>
                        </div>
                    </div>
                </div>
