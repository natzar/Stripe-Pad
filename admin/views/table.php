          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            ?>
              <tr id="recordsArray_<?= $row[$table_no_prefix . 'Id'] ?>" class="<?= $rowClass ?> items-center">
                <td class="px-4 py-5 text-xs font-semibold text-gray-900 items-center">
                  <a class="hover:text-blue-500" href='<?= ADMIN_URL ?>app_<?= $table ?>/<?= $row[$table . 'Id'] ?>' rel="nofollow"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
